...
- **Dynamic memory allocation with new and delete**
    ...
    - **Memory leaks**
        - Memory leaks happen when your program loses the address of some bit of dynamically allocated memory before giving it back to the operating system.The
        - program can’t delete the dynamically allocated memory, because it no longer knows where it is.
