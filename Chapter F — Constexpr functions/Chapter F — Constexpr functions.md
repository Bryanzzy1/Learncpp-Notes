...
- **[[Constexpr Function Rules]]**
    ...
    - **[[Constexpr Function Parameters|Constexpr/consteval function parameters are not constexpr]]**
    - **[[Constexpr Functions Implicitly Inline|Constexpr functions are implicitly inline]]**
...
- **[[Constexpr Function Capabilities|Constexpr/consteval functions can use non-const local variables]]**
- **[[Constexpr Function Capabilities|Constexpr/consteval functions can use function parameters and local variables as arguments in constexpr function calls]]**
...
- A **[[Pure Functions|pure function]]** is a function that meets the following criteria:
